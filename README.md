...
Además le damos el formato que queremos a cada uno de los formularios par que se vean mejor.
...
Ahora necesitamos ejecutar la factoria para que cree los registros y complete la base de datos. Hay que poner freshh para que borre los datos existentes y  --seed para que después de hacer la migración haga las poblaciones. 

```
php artisan migrate:fresh --seed
```
![UBD con registros](public/images/bd_registros.PNG)
